...
export const metadata = {
  title: "How CareFlow Works | Connected AI Workflow",
  description:
    "Learn how CareFlow coordinates patient intake, lab OCR, radiology AI, and clinical decision support into a unified doctor dashboard.",
};
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            <div className="p-6 rounded-2xl bg-white dark:bg-[#0b1f24] border border-slate-200 dark:border-teal-900/40 space-y-3">
              ...
              <p className="text-xs text-slate-600 dark:text-slate-300 leading-relaxed">
                Processes unstructured audio streams, paper lab PDFs, and DICOM imaging files concurrently without manual intervention.
              </p>
            </div>
            <div className="p-6 rounded-2xl bg-white dark:bg-[#0b1f24] border border-slate-200 dark:border-teal-900/40 space-y-3">
              ...
              <p className="text-xs text-slate-600 dark:text-slate-300 leading-relaxed">
                Retrieves up-to-date treatment guidelines (IDSA, ACC, ADA) to ground all differential diagnoses and recommendations.
              </p>
            </div>
            <div className="p-6 rounded-2xl bg-white dark:bg-[#0b1f24] border border-slate-200 dark:border-teal-900/40 space-y-3">
